...
ssize_t device_read_jiffies(struct file *filp, char *bufStoreData,
...
ssize_t device_read_foo(struct file *filp, char *bufStoreData,
			size_t bufCount, loff_t *curOffset)
{
	int ret;
...
ssize_t device_write_foo(struct file *filp, const char *bufSourceData,
			 size_t bufCount, loff_t *curOffset)
{
	int ret;
